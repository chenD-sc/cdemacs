...
(setq scheme-program-nam "scheme")
...
;;           (lambda ()
;;             (paredit-mode 1)
;;             (define-key scheme-mode-map (kbd "e") 'scheme-send-last-sexp-split-window)
;;             (define-key scheme-mode-map (kbd "E") 'scheme-send-definition-split-window)))
