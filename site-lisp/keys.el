...
(global-set-key "\C-o" 'cda-open-line)                   ; 'open-line
...
(global-set-key (kbd "C-κ") 'cda-kill-current-buffer)          ; [k]
...
(global-set-key "ρ" 'cda-brackets)                           ; [r]
...
(global-set-key "φ" 'cda-parens)                             ; [f]
;; (global-set-key (kbd ">") 'self-insert-command)           ; [g]
(global-set-key "η" 'cda-save-and-switch-buffer)             ; [h]
...
;;* Meta shortcuts
(global-set-key (kbd "M-%") 'cda-query-replace)
...
(global-set-key (kbd "C-c g") 'cda-counsel-git)
...
(global-set-key (kbd "C-c D") 'cda-insert-date-from)
...
(global-set-key [f11] 'cda-org-clock-out)
...
(defhydra hydra-k (:color blue
  ...
  ("e" cda-ediff-dwim "ediff")
  ("f" cda-flyspell-previous-word "flyspell")
  ("j" dired-jump "dired")
  ...
  ("p" cda-project "project")
  ("s" hydra-search/body "search")
  ("n" cda-open-wikitionary "wikitionary")
  ("N" cda-open-google-translate "google-translate")
  ("t" tea-time "tea")
  ("y" avy-copy-region "yank region")
  ("w" plain-org-wiki "wiki")
  ("W" cda-open-wikipedia "wikipedia")
  ("q" nil "quit"))

(autoload 'hydra-search/body "cda-search")
...
(global-set-key (kbd "C-M-k") 'cda-kill-current-buffer)
...
(global-set-key (kbd "<down-mouse-3>") 'cda-open-file-at-point)
