...
(add-to-list 'auto-insert-alist
             '(python-mode lambda nil (cda-python-auto-insert)))
(defun cda-python-auto-insert ()
  (insert "#* Imports\n\n\n")
...
(defun cda-python-hook ()
  ...
  (setq forward-sexp-function 'cda-c-forward-sexp-function)
  (lpy-mode)
...
(defun cda-python-shell-send-region (start end &optional nomain)
...
;;;###autoload
(defun cda-inferior-python-hook ()
  (setq next-error-function 'cda-comint-next-error-function))

(defun cda-comint-next-error-function (n &optional reset)
  (interactive "p")
  (when reset
